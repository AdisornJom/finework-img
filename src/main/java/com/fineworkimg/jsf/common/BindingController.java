...
public class BindingController implements Serializable {
    ...
    private TreeTable defaultTreeTableModel;
    ...
    public static final String DATATABLE_ROWS_TEMPLATE = "50,100,150,200";
...
//    public static final String DATATABLE_CURRENT_PAGE_REPORT_TEMPLATE = "(ข้อมูล {startRecord} - {endRecord} จาก {totalRecords}, หน้า {currentPage}/{totalPages})";
    ...
    public static final String TREETABLE_SELECTIION_MODE="single";
    ...
    public Dialog getDefaultDialogModel() {
        ...
        defaultDialogModel.setResponsive(true);
...
//        defaultDialogModel.setFooter("<font style=\"color: #666666;font-size: smaller;\">" + MessageBundleLoader.getMessage(MessageBundleLoader.APP_MESSAGE_PATH, "app.footer") + "</font>");
    ...
    public DataTable getDataTableModel() {
        ...
        //dataTableModel.setStickyHeader(true);
    ...
    public DataTable getDefaultDataTableModel() {
        ...
        //defaultDataTableModel.setStickyHeader(true);
    ...
    public DataTable getLazyDataTableModel() {
        ...
        //lazyDataTableModel.setStickyHeader(true);
        lazyDataTableModel.setEmptyMessage(MessageBundleLoader.getMessage("messages.code.2015"));
        return lazyDataTableModel;
    }

    public TreeTable getDefaultTreeTableModel() {
        defaultTreeTableModel = new TreeTable();
        defaultTreeTableModel.setRows(Integer.parseInt(DATATABLE_ROWS));
        defaultTreeTableModel.setPaginator(true);
        defaultTreeTableModel.setPaginatorPosition(DATATABLE_PAGINATOR_POSITION);
        defaultTreeTableModel.setPaginatorTemplate(DATATABLE_PAGINATOR_TEMPLATE);
        defaultTreeTableModel.setRowsPerPageTemplate(DATATABLE_ROWS_TEMPLATE);
        defaultTreeTableModel.setCurrentPageReportTemplate(DATATABLE_CURRENT_PAGE_REPORT_TEMPLATE);
        defaultTreeTableModel.setSelectionMode(TREETABLE_SELECTIION_MODE);
        defaultTreeTableModel.setEmptyMessage(MessageBundleLoader.getMessage("messages.code.2015"));
...
//        btnCancel.setValue(MessageBundleLoader.getMessage("btn.cancel"));
    ...
    public void setDefaultTreeTableModel(TreeTable defaultTreeTableModel) {
        this.defaultTreeTableModel = defaultTreeTableModel;
}
}
